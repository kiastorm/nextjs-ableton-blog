...
export const textField = css({
  ...
  boxShadow: `inset 0 0 0 1px #505050`,
  color: "$hiContrast",
  ...
  "&:focus": {
    boxShadow: "inset 0px 0px 0px 2px rgb(229, 151, 0)",
    "&:-webkit-autofill": {
      boxShadow:
        "inset 0px 0px 0px 1px rgb(229, 151, 0), 0px 0px 0px 1px rgb(229, 151, 0), inset 0 0 0 100px $colors$blue3",
    },
  },
  "&::placeholder": {
    color: "$slate9",
